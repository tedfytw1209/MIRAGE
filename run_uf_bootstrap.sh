...
#
# Test run: only run_cls_tuning_UF_multimodaliy.py (true multi-modal),
#   MIRAGE-Large, --linear_probing -- deliberately narrow, to validate the
#   --new_subset_num bootstrap path end-to-end before widening to Base /
#   single-modality / full-fine-tune.
